    ...
    src/
        ...
        components/
            ...
            sections/
                ...
                EventsSection.tsx               # Home teaser for latest events
            ...
            events/
                ...
                CategoryTabs.tsx                # Organized/Hackathon/Experience/Mentorship tabs
    ...
    - writing posts
    - releases
    - events (categorized as organized, hackathon, experience, mentorship)
    - top skills
    - certifications
    - experience timeline
    - education timeline
    ...
    - dedicated `/events` metadata + OpenGraph configuration
    - `/events` included in sitemap generation
    ...
    - events category tabs with active-state filtering
